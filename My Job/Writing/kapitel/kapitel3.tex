...
\begin{figure}[htbp]\centering
	...
	\end{minipage}
	\caption{various of data combinations are used to estimate the runoff, there are 3 metrics (PBIAS, correlation and NSE wrt. GRDC) to judge the quality of these combinations for Ob basin, the x-axis are the combinations of different datasets}
